...
(function($){
	...
	$.ajax({
                ...
                if(result.status == 'success') {
                    $this.val('');
                    $('.note-image-url').val(result.file_url);
                    $('.note-image-btn').removeAttr('disabled');
                }
                else{
                    $(".imgError").html('<div class="alert alert-error"><button type="button" class="close" data-dismiss="alert">×</button>'+result.message+'</div>');	
                }
