...
@section('content')
    ...
    <div class="row">
        <form class="form-horizontal" role="form"  method="POST" action="{{ url('/hotels/'.$hotel->id)  }} " enctype="multipart/form-data" >
        <div class="col-md-8">
                ...
                <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <label for="name" >{{ __('Name*') }}</label>
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ isset($hotel->name) ? $hotel->name : old('name') }}"   autofocus>
                         ...
                         <div class="form-group">                         
                           <div class="col-md-12">
                            ...
                            <textarea name="description" id="description" class="form-control" cols="40" rows="4" placeholder="Enter the description" >{{ isset($hotel->description) ? $hotel->description : old('description') }}</textarea>                             
