                        ...
                        @endphp
                            ...
                            <div class="col-md-6 form-check-inline">             
                                <div class="form-check">  
                                    <input class="form-check-input" name="permissions[]" type="checkbox"value="role-create" {{ !empty($permissions) && ( in_array("role-create",$permissions) )? 'checked':'' }}>
                                    <label class="form-check-label" for="inlineCheckbox1">Add</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" name="permissions[]" type="checkbox"value="role-edit" {{ !empty($permissions) && ( in_array("role-edit",$permissions) )? 'checked':'' }}>
                                    <label class="form-check-label" for="inlineCheckbox2">Edit</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" name="permissions[]" type="checkbox"value="role-update" {{ !empty($permissions) && ( in_array("role-update",$permissions) )? 'checked':'' }}>
                                    <label class="form-check-label" for="inlineCheckbox2">Update</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" name="permissions[]" type="checkbox"value="role-delete" {{ !empty($permissions) && ( in_array("role-delete",$permissions) )? 'checked':'' }}>
