...
@section('content')
    ...
    <div class="row">
        <form class="form-horizontal" role="form"  method="POST" action="{{ url('/menuitems/'.$menuitem->id) }}" enctype="multipart/form-data" >
        <div class="col-md-8">
                            ...
                            <div class="col-md-12">
                                ...
                                <span class="result-featured" style="{{ ( !empty($menuitem->image))? 'display:block;':'display:none;'  }}">
                                    <a href="javascript:void(0);" class="remove-featured red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                        <img src="{{  url('storage/app/public/media/'.@$menuitem->image)}}" width="90">
                                </span>
